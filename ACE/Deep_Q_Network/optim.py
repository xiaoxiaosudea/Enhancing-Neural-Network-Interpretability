...
class optim(tk.Tk, object):
    def __init__(self):
        ...
        self._build_maze()
        self.image_path = "D:\PaperCode\ACE-1\susu_new\ImageNet\\verify\wolf_in_snow_fore\white_wolf\\3\saved\\0023.png"
        self.image = cv2.imread("D:\PaperCode\ACE-1\susu_new\ImageNet\\verify\wolf_in_snow_fore\white_wolf\\3\saved\\0023.png")
        self.concept_path ="D:\PaperCode\ACE-1\susu_new\ImageNet\\verify\wolf_in_snow_fore\white_wolf\\3\\add"
        self.save_dic = "D:\PaperCode\ACE-1\susu_new\ImageNet\\verify\wolf_in_snow_fore\white_wolf\\3\DQN-10"
        self.i = 0
        self.j = 0
        self.real_id = 0
    ...
    def step(self, action):
        ...
        # image送入预测网络
        class_id_start = susu_ckpt_to_pb_and_predict.freeze_graph_test_1("D:\PaperCode\ACE-1\susu_new\susu_V1_0.9922_tensorflow.pb", self.image_path)
        ...
        for patch_file in patches:
            ...
            # d = 0
            if self.i * 112 > self.image.shape[1]:
                self.i = 0
                self.j += 1
            if self.j * 112 > self.image.shape[0]:
                self. i = 0
                self. j = 0
            # print(f"iiiiii {i}, {j}")
            ...
            c = self.j
            ff = 0
            for self.j in range(c, 21):
                for self.i in range(b, 21):
                    # print(f"{self.i}, {self.j}")
                    x, y = (self.i * 112, self.j * 112)  # 图像叠加位置
                    # i += 1
        ...
        # 送进预测网络
        class_id_final = susu_ckpt_to_pb_and_predict.freeze_graph_test_1("D:\PaperCode\ACE-1\susu_new\susu_V1_0.9922_tensorflow.pb", sy_image_path)
